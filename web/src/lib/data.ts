...
/** Role family for Agent Manager filters (AGENTS.md tiers). */
...
export type AgentLegacyStatus = "online" | "standby" | "dormant" | "idle";

export type AgentRecord = {
  id: string;
  role: string;
  /** Display tier string kept for Agent Teams cards. */
  tier: string;
  tierKey: AgentTierKey;
  port: string;
  model: string;
  roleFamily: AgentRoleFamily;
  /** Legacy status used by Agent Teams. */
  status: AgentLegacyStatus;
 ...
 * HYPERION is the operator interface (not counted in the 20).
 */
export const agents: AgentRecord[] = [
  {
    id: "ARCHON",
    role: "Orchestrator + A2A",
    tier: "T2 :30001",
    tierKey: "2",
    port: ":30001",
    ...
    priority: 1,
    slotWeight: 1.0,
    capabilities: ["a2a_coord", "pipeline_activate", "subagent_spawn"],
    pipelines: ["P1", "P5", "P12"],
    skills: ["orchestrator", "a2a_bridge"],
    lastHeartbeatAt: "2026-07-09T23:58:12Z",
    lastActivity: "Routed P12 intent solver review",
    confidence: 0.91,
    bftRole: "orch_voter",
    notes: "Command chain root · BFT voter A",
  },
  {
    id: "CORTEX",
    role: "Meta / GEPA / PRM",
    ...
    tierKey: "3a",
    port: ":30005",
    model: "DeepSeek V4 Pro (fallback T2)",
    roleFamily: "orch",
    status: "standby",
    runStatus: "IDLE",
    load: 8,
    priority: 3,
    slotWeight: 0.4,
    capabilities: ["gepa_judge", "prm_vote", "deep_reflection"],
    pipelines: [],
    skills: ["gepa", "prm"],
    lastHeartbeatAt: "2026-07-09T22:10:00Z",
    lastActivity: "Standby — R&D deep-vote path offline",
    confidence: 0.62,
    bftRole: "orch_voter",
    notes: "BFT voter B · preferred :30005; fallback :30001",
  },
  {
    id: "GUARDIAN",
    role: "Risk / Kelly",
    ...
    priority: 1,
    slotWeight: 1.0,
    capabilities: ["trade_veto", "kelly_size", "cb_enforce"],
    pipelines: ["P1", "P5", "P12", "P22"],
    skills: ["risk_kernel_client", "kelly"],
    lastHeartbeatAt: "2026-07-09T23:59:40Z",
    lastActivity: "Kelly resize P5 funding carry",
    confidence: 0.94,
    bftRole: "veto",
    notes: "BFT voter C · critical path · veto authority",
  },
  {
    id: "SENTINEL",
    role: "Security / CodeQL / PCR",
    tier: "T2 :30001",
    tierKey: "2",
    port: ":30001",
    model: "Qwen3-Coder-Next-80B",
    ...
    priority: 2,
    slotWeight: 0.7,
    capabilities: ["codeql", "pcr_drift", "security_audit"],
    pipelines: [],
    skills: ["security_ops", "codeql"],
    lastHeartbeatAt: "2026-07-09T23:57:01Z",
    lastActivity: "PCR drift check PASS",
    confidence: 0.88,
  },
  {
    id: "ORACLE",
    role: "Signals (108 classical)",
    tier: "T1 :30000",
    tierKey: "1",
    port: ":30000",
    model: "Qwen3-30B-A3B FP8",
    ...
    priority: 1,
    slotWeight: 0.95,
    capabilities: ["fundamentals", "sentiment", "news", "technical"],
    pipelines: ["P1", "P5"],
    skills: ["signal_fusion", "analyst_pipeline"],
    lastHeartbeatAt: "2026-07-09T23:59:10Z",
    lastActivity: "Emitted TechnicalReport · WETH/USDC",
    confidence: 0.79,
  },
  {
    id: "WRAITH",
    ...
    priority: 2,
    slotWeight: 0.85,
    capabilities: ["wallet_graph", "tvl_trace", "contract_scan"],
    pipelines: ["P12", "P6"],
    skills: ["onchain", "hypergraph_query"],
    lastHeartbeatAt: "2026-07-09T23:56:44Z",
    lastActivity: "Graph-R1 query · Morpho liquidations",
    confidence: 0.81,
  },
  {
    id: "PREDATOR",
    ...
    priority: 1,
    slotWeight: 0.9,
    capabilities: ["mempool_scan", "snipe", "threat_hunt"],
    pipelines: ["P22", "P29"],
    skills: ["predator_hunt", "ghost_evasion"],
    lastHeartbeatAt: "2026-07-09T23:59:22Z",
    lastActivity: "BFT trade vote COMMIT · P1",
    confidence: 0.84,
    bftRole: "trade_voter",
    notes: "Trade BFT voter · stalking pillar",
  },
  {
    id: "AUGUR",
    role: "Macro regime",
    ...
    priority: 1,
    slotWeight: 0.8,
    capabilities: ["regime_detect", "macro_gate", "bft_vote"],
    pipelines: ["P1", "P5"],
    skills: ["regime", "macro"],
    lastHeartbeatAt: "2026-07-09T23:58:55Z",
    lastActivity: "Regime NEUTRAL · BFT vote REVEAL",
    confidence: 0.86,
    bftRole: "trade_voter",
    notes: "Trade BFT voter · shares Tier 1 with PREDATOR",
  },
  {
    id: "NARRATIVE",
    role: "Catalyst ingestion",
    tier: "T1 :30000",
    tierKey: "1",
    port: ":30000",
    model: "Qwen3-30B-A3B FP8",
    ...
    priority: 3,
    slotWeight: 0.5,
    capabilities: ["news_ingest", "catalyst_score"],
    pipelines: [],
    skills: ["narrative", "crypto_news"],
    lastHeartbeatAt: "2026-07-09T20:12:00Z",
    lastActivity: "Heartbeat overdue — feed worker restart pending",
    confidence: 0.41,
    notes: "Demo DOWN for alert strip · classical catalyst path",
  },
  {
    id: "TRENCH-OPS",
    role: "Execution + signing",
    tier: "T1 :30000",
    tierKey: "1",
    port: ":30000",
    model: "Qwen3-30B-A3B FP8",
    ...
    priority: 1,
    slotWeight: 1.0,
    capabilities: ["gate_sign", "edge_dispatch", "intent_submit"],
    pipelines: ["P1", "P5", "P12", "P22"],
    skills: ["trench_ops", "signing_in_process", "edge_route"],
    lastHeartbeatAt: "2026-07-09T23:59:50Z",
    lastActivity: "In-process SigningNode · gate receipt OK",
    confidence: 0.93,
    notes: "Signing via titan-safety in-process · no :19010 hop",
  },
  {
    id: "LAMARCK",
    role: "Post-trade / OPD / GEPA",
    tier: "T2 :30001",
    tierKey: "2",
    port: ":30001",
    model: "Qwen3-Coder-Next-80B",
    ...
    priority: 2,
    slotWeight: 0.65,
    capabilities: ["opd", "gepa_reflect", "decision_log"],
    pipelines: ["P1", "P5"],
    skills: ["lamarck", "reflection"],
    lastHeartbeatAt: "2026-07-09T23:54:18Z",
    lastActivity: "Wrote decision_log reflection · P1",
    confidence: 0.77,
  },
  {
    id: "DARWIN_GODEL",
    role: "Auto-research / DGM-H",
    tier: "T3a :30005",
    tierKey: "3a",
    port: ":30005",
    ...
    priority: 4,
    slotWeight: 0.3,
    capabilities: ["dgm_h", "shadow_evolve", "skill_opt"],
    pipelines: [],
    skills: ["darwin_godel", "dgm_h"],
    lastHeartbeatAt: "2026-07-09T21:40:00Z",
    lastActivity: "Shadow-only · never live critical path",
    confidence: 0.55,
    notes: "Evolution shadow · human YES for live",
  },
  {
    id: "HERALD",
    ...
    tierKey: "U",
    port: ":30002",
    model: "Qwen3-30B TITANSPARK FP4",
    roleFamily: "utility",
    status: "online",
    runStatus: "UP",
    load: 12,
    priority: 2,
    slotWeight: 0.5,
    capabilities: ["telegram", "alert_fanout"],
    pipelines: [],
    skills: ["herald"],
    lastHeartbeatAt: "2026-07-09T23:57:40Z",
    lastActivity: "Pushed CB watch digest → EDGE-FRA",
    confidence: 0.9,
  },
  {
    id: "NEXUS",
    role: "Data feeds / funding / AVS",
    tier: "U :30002",
    tierKey: "U",
    port: ":30002",
    model: "Qwen3-30B TITANSPARK FP4",
    ...
    priority: 2,
    slotWeight: 0.6,
    capabilities: ["funding_rate", "avs_registry", "feed_health"],
    pipelines: ["P5"],
    skills: ["nexus", "funding"],
    lastHeartbeatAt: "2026-07-09T23:58:02Z",
    lastActivity: "Funding rate snapshot · HL",
    confidence: 0.83,
  },
  {
    id: "FORGE",
    role: "Infra / inference health",
    tier: "U :30002",
    tierKey: "U",
    port: ":30002",
    model: "Qwen3-30B TITANSPARK FP4",
    ...
    priority: 2,
    slotWeight: 0.6,
    capabilities: ["strategy_health", "inference_probe", "edge_health"],
    pipelines: [],
    skills: ["forge"],
    lastHeartbeatAt: "2026-07-09T23:59:01Z",
    lastActivity: "Tier probe :30000/:30001/:30002 OK",
    confidence: 0.89,
  },
  {
    id: "ALCHEMY",
    role: "DeFi / liquidation / NFT-RWA",
    tier: "U :30002",
    tierKey: "U",
    port: ":30002",
    model: "Qwen3-30B TITANSPARK FP4",
    ...
    priority: 2,
    slotWeight: 0.7,
    capabilities: ["liquidation", "flash_compose", "avs_opt"],
    pipelines: ["P6", "P12"],
    skills: ["alchemy", "flash_loan"],
    lastHeartbeatAt: "2026-07-09T23:55:33Z",
    lastActivity: "Composed Morpho liquidation sim",
    confidence: 0.8,
  },
  {
    id: "ATLAS",
    ...
    priority: 1,
    slotWeight: 0.85,
    capabilities: ["equity_headroom", "margin", "bft_vote"],
    pipelines: ["P1", "P5", "P12"],
    skills: ["atlas", "portfolio"],
    lastHeartbeatAt: "2026-07-09T23:59:05Z",
    lastActivity: "BFT trade vote · equity headroom OK",
    confidence: 0.87,
    bftRole: "trade_voter",
    notes: "Trade BFT voter · utility tier",
  },
  {
    id: "QUANT",
    role: "Statistical / pairs / PM arb",
    tier: "U :30002",
    tierKey: "U",
    port: ":30002",
    model: "Qwen3-30B TITANSPARK FP4",
    ...
    priority: 3,
    slotWeight: 0.4,
    capabilities: ["pairs", "stat_arb", "prediction_arb"],
    pipelines: [],
    skills: ["quant"],
    lastHeartbeatAt: "2026-07-09T23:20:00Z",
    lastActivity: "Paused advisory — no funded pairs lane",
    confidence: 0.58,
  },
  {
    id: "ARBITER",
    role: "Backtest / Red Team",
    tier: "U :30002",
    tierKey: "U",
    port: ":30002",
    model: "Qwen3-30B TITANSPARK FP4",
    ...
    priority: 2,
    slotWeight: 0.55,
    capabilities: ["walk_forward", "red_team", "scorecard"],
    pipelines: ["P34"],
    skills: ["arbiter", "deploy_lifecycle"],
    lastHeartbeatAt: "2026-07-09T23:52:11Z",
    lastActivity: "Walk-forward P34 CLMM 2.0",
    confidence: 0.82,
  },
  {
    id: "HORIZON",
    role: "R&D metrology (CSET)",
    tier: "U :30002",
    tierKey: "U",
    port: ":30002",
    model: "Qwen3-30B TITANSPARK FP4",
    ...
    priority: 3,
    slotWeight: 0.35,
    capabilities: ["cset_observer", "metrology"],
    pipelines: [],
    skills: ["horizon"],
    lastHeartbeatAt: "2026-07-09T22:05:00Z",
    lastActivity: "Heartbeat stale — CSET observer lag",
    confidence: 0.64,
    notes: "Overdue heartbeat for alert demo",
  },
];

export const agentRoleFamilyLabels: Record<AgentRoleFamily, string> = {
  orch: "Orchestrator",
  risk: "Risk / Security",
  signal: "Signal / Macro",
  exec: "Execution",
...
/** Inference ports used by the 20-agent fleet (live path focus). */
export const agentInferencePorts = [
  {
    port: ":30000",
    tier: "1" as const,
    label: "Tier 1 · Qwen3-30B FP8",
    host: "TITANHOME",
    status: "UP" as const,
    agents: agents.filter((a) => a.port === ":30000").map((a) => a.id),
  },
  {
    port: ":30001",
    tier: "2" as const,
    label: "Tier 2 · Qwen3-Coder-80B",
    host: "TITANHOME",
    status: "UP" as const,
    agents: agents.filter((a) => a.port === ":30001").map((a) => a.id),
  },
  {
    port: ":30002",
    tier: "U" as const,
    label: "Utility · TITANSPARK SGLang",
    host: "TITANSPARK",
    status: "UP" as const,
    agents: agents.filter((a) => a.port === ":30002").map((a) => a.id),
  },
  {
    port: ":30005",
    tier: "3a" as const,
    label: "Tier 3a · DeepSeek V4 Pro (R&D)",
    host: "TITANHOME offload",
    status: "IDLE" as const,
    agents: agents.filter((a) => a.port === ":30005").map((a) => a.id),
  },
];

/** Advisory 2-of-3 trade BFT + orchestrator note (votes not cryptographic BFT). */
export const agentBftStatus = {
  tradeVoters: [
    { id: "AUGUR", vote: "COMMIT" as const, signed: true, note: "regime NEUTRAL" },
    { id: "PREDATOR", vote: "COMMIT" as const, signed: true, note: "mempool clear" },
    { id: "ATLAS", vote: "COMMIT" as const, signed: true, note: "equity headroom OK" },
  ],
  threshold: "2-of-3",
  consensus: "AUTHORIZE" as const,
  authoritativeGate: "risk kernel :19001 DENY wins",
  orchNote:
    "Orchestrator BFT (ARCHON / CORTEX / GUARDIAN) is advisory heterogeneous consensus — GUARDIAN on Tier 1 critical path.",
};

export const agentAlerts = [
  {
    id: "alert-narrative-down",
    severity: "warn" as const,
    agentId: "NARRATIVE",
    title: "NARRATIVE DOWN",
    detail: "Catalyst ingestion heartbeat overdue · feed worker restart advisory",
    at: "2026-07-09T23:50:00Z",
  },
  {
    id: "alert-horizon-hb",
    severity: "warn" as const,
    agentId: "HORIZON",
    title: "HORIZON heartbeat stale",
    detail: "Last beat >90m ago · CSET observer lag",
    at: "2026-07-09T23:48:00Z",
  },
  {
    id: "alert-tier3a-idle",
    severity: "info" as const,
    agentId: "CORTEX",
    title: "Tier 3a :30005 IDLE",
    detail: "CORTEX / DARWIN_GODEL on R&D offload — fallback Tier 2 for CORTEX votes",
    at: "2026-07-09T22:15:00Z",
  },
];

export function agentFleetSummary(roster: AgentRecord[] = agents) {
  const byStatus = {
    UP: roster.filter((a) => a.runStatus === "UP").length,
    DOWN: roster.filter((a) => a.runStatus === "DOWN").length,
    DORMANT: roster.filter((a) => a.runStatus === "DORMANT").length,
    IDLE: roster.filter((a) => a.runStatus === "IDLE").length,
  };
  const byTier = {
    t1: roster.filter((a) => a.tierKey === "1").length,
    t2: roster.filter((a) => a.tierKey === "2").length,
    t3a: roster.filter((a) => a.tierKey === "3a").length,
    u: roster.filter((a) => a.tierKey === "U").length,
  };
