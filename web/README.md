...
> **Production ops:** Telegram via HERALD is the sole operator surface — see [`../TELEGRAM_OPS_GUIDE.md`](../TELEGRAM_OPS_GUIDE.md). This web UI is for **local dev and reference** only; do not rely on it for production operations.
...
**Beginner one-stop (UI live + providers + real crypto/money path):** [`../BEGINNER_WEB_UI_LIVE_MONEY_GUIDE.md`](../BEGINNER_WEB_UI_LIVE_MONEY_GUIDE.md) — **UI live ≠ capital live.**
